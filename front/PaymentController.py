...
def Post():
    response = PaymentRepository.Create(request)
...
def Get():
    response = PaymentRepository.Read(request)
...
def Get_By_Id(id: int):
    response = PaymentRepository.Read_by_id(id)
...
def Update(id: int):
    ...
    response = PaymentRepository.Update(id, request)
...
def Delete(id: int):
    response = PaymentRepository.Delete(id)
    if response == None:
